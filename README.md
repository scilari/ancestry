# Ancestry Tree implementation in Scala
Ancestry trees are a lightweight pattern that can be used for example in particle filtering to compactly store the mutual history [1, 2].
